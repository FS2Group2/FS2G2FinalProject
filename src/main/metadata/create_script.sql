...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `eventtour`.`user_profile` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `eventtour`.`country` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `eventtour`.`location` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_country`
    ...
    REFERENCES `eventtour`.`country` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `eventtour`.`user` (
  ...
  CONSTRAINT `fk_user_role`
    ...
    REFERENCES `eventtour`.`role` (`r_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_user_profile`
    FOREIGN KEY (`u_profife`)
    REFERENCES `eventtour`.`user_profile` (`user_id`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION,
  CONSTRAINT `fd_default_location`
    FOREIGN KEY (`u_default_location`)
    REFERENCES `eventtour`.`location` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `eventtour`.`event_info` (
...
CREATE TABLE IF NOT EXISTS `eventtour`.`event` (
  ...
  CONSTRAINT `fk_info`
    FOREIGN KEY (`e_info`)
    REFERENCES `eventtour`.`event_info` (`ei_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `eventtour`.`transfer_type` (
...
CREATE TABLE IF NOT EXISTS `eventtour`.`transfer` (
  ...
  CONSTRAINT `fk_t_type`
    FOREIGN KEY (`t_type`)
    REFERENCES `eventtour`.`transfer_type` (`tt_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `eventtour`.`accomodation` (
...
CREATE TABLE IF NOT EXISTS `eventtour`.`wishlist` (
  ...
  CONSTRAINT `fk_w_event`
    FOREIGN KEY (`w_event`)
    REFERENCES `eventtour`.`event` (`e_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `eventtour`.`purchase` (
  ...
  CONSTRAINT `fk_p_transfer`
    ...
    REFERENCES `eventtour`.`transfer` (`t_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_p_accomodation`
    FOREIGN KEY (`p_accomodation`)
    REFERENCES `eventtour`.`accomodation` (`a_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
START TRANSACTION;
USE `eventtour`;
INSERT INTO `eventtour`.`role` (`r_id`, `r_name`) VALUES (1, 'user');
INSERT INTO `eventtour`.`role` (`r_id`, `r_name`) VALUES (2, 'supplier');
INSERT INTO `eventtour`.`role` (`r_id`, `r_name`) VALUES (3, 'admin');
...
START TRANSACTION;
USE `eventtour`;
INSERT INTO `eventtour`.`transfer_type` (`tt_id`, `tt_name`) VALUES (1, 'bus');
INSERT INTO `eventtour`.`transfer_type` (`tt_id`, `tt_name`) VALUES (2, 'air');
INSERT INTO `eventtour`.`transfer_type` (`tt_id`, `tt_name`) VALUES (3, 'train');
INSERT INTO `eventtour`.`transfer_type` (`tt_id`, `tt_name`) VALUES (4, 'ship');
INSERT INTO `eventtour`.`transfer_type` (`tt_id`, `tt_name`) VALUES (5, 'taxi');
